...
On the JPEG data the measured answer is ~1.065, i.e. essentially no compression.
    ...
    python v7/report_display_exponent.py \\
        --reference /home/slavik/tmp/eclipse_v2_run_20260804/v2-stage3_composite.npy \\
        --composite /home/slavik/tmp/eclipse_v7_run/v7-stage3_composite.npy
"""
...
from eclipse_v7.merge import NO_DATA          # noqa: E402
from eclipse_v7.stage3 import brightness_spread  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--composite", type=Path, required=True,
                    help="v7-stage3_composite.npy — the new merge's physical brightness")
    ...
    print(f"  => set eclipse_v7/stage3.py  DISPLAY_GAMMA = {gamma:.3f}")
