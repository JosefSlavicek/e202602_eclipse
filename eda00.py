# eda00.py: same pipeline as eda00.ipynb, no visualizations. Saves exposure_groups and reg to a pickle file.
...
DATA_ROOT = os.environ.get("EDA00_DATA_ROOT", "/home/slavik/e202602_eclipse/data")
BRIGHTNESS_MIN = 0.0
BRIGHTNESS_MAX = 1.0
...
def get_image_infos():
    jpg_files = list(Path(DATA_ROOT).rglob("*.jpg")) + list(
