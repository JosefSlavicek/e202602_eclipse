...
| `eclipse_v5/reregister.py` | redoes the cross-exposure registration on calibrated radiance; writes `v5-stage2r.pkl` |
...
python v5/test_reregister_smoke.py                # verify the re-registration
...
python v5/pipeline.py --refine-registration off   # stage 2's gamma-scaled alignment, as before
python v5/compare_registration_radiance.py        # how much does the refinement actually move?
