...
Run directly (`python v5/test_merge_smoke.py`) or under pytest. Needs CUDA.
"""
...
from eclipse_v5.inputs import FrameSource                # noqa: E402
from eclipse_v5.merge import NO_DATA, merge_to_composite  # noqa: E402
from eclipse_v5.stage0 import ImageInfo                  # noqa: E402
from eclipse_v5.stage3 import Stage3Context              # noqa: E402
...
class SyntheticSource(FrameSource):
    ...
    def load_radiance(self, ii, device):
        ...
        from eclipse_v5.inputs import JpgSource
