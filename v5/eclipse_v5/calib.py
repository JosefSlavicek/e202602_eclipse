...
`v5/test_calib_synthetic.py` exercise the numerics in ~10 s on CPU.
"""
...
from eclipse_v5.utils import compute_weighted_average, moon_median
from eclipse_v5.warp import build_chains, sample_at_ref_points, warp_to_ref
