...
def unlock_and_burst():
    ...
    try:
        for _ in range(4):
            ...
            do_burst('0.0015s',   '1 EV', '9 images (normal, 4 unders and 4 overs)')
            do_burst('0.0769s',   '1 EV', '7 images (normal, 3 unders and 3 overs)')
            do_burst('0.0012s',   '1 EV', '9 images (normal, 4 unders and 4 overs)')
            do_burst('0.1250s',   '1 EV', '7 images (normal, 3 unders and 3 overs)')
            #do_burst('0.15s',   '1 EV', '7 images (normal, 3 unders and 3 overs)')
