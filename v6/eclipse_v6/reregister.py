...
from eclipse_v6.merge import average_exposure_radiance
from eclipse_v6.utils import grid_search_registration, moon_median
...
def average_radiance(group, opt_results, exp, source, device):
    ...
    Lbar, _var, covered, _moon_out, _frames = average_exposure_radiance(
